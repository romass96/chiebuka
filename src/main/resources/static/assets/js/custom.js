...
$(document).ready(function (e) {
        ...
        if (product_detail_el.length == 1) {
            ...
            trigger_el.on('click', function (e) {
                ...
                if ($(window).scrollTop() + $(window).height() - 200 < product_details_container.offset().top) {
                    $.scrollTo(product_details_container.offset().top - 100, 800, {
                        axis: 'y'
                    });
                }
            });
    ...
    function googleMap() {
        ...
        var myLatlng = new google.maps.LatLng(50.436720, 30.527235); //position of the map marker
        var center = new google.maps.LatLng(50.436720, 30.527235); //center of the map
