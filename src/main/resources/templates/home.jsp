...
<header class="page-header page-header-normal">
    <div class="page-top">
        <div class="container">
            <div class="row">
                <div class="col-xs-6">
                    <em>Звони сейчас: 0 800 - 248 -248</em>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="main-navigation-inner">
            <div class="container">
                <div class="relative-container clearfix">
                    ...
                    <div id="main-cart-button" class="has-small-label cart-trigger">
...
<section>
    <div class="container">
        <div id="product-slider" class="owl-pagination-dash owl-navigation-box">
            <div class="offer">
                <img alt="product" src="assets/images/menu/main1.jpg">
                <div class="offer-price-small">
                    <span class="offer-price-val1">125</span><span class="offer-price-val2">грн</span>
                </div>
                <div class="offer-detail">
                    <div class="offer-detail-inner">
                        <div class="offer-detail-content">
                            <h6>Жареный цыпленок</h6>
                            <div class="price-huge clearfix">
                                <div class="pull-left">
                                    <span class="price-val-1">125</span>
                                </div>
                                <div class="pull-left">
                                    <span class="price-val-2">грн</span><br>
                                </div>
                            </div>
                            <div style="margin-top: 20px">
                                <a href="#" class="button-red button-text-big cart-trigger">Заказать</a>
                            </div>
                        </div>
                    </div>
                    <!-- .offer-detail-inner -->
            ...
            <!-- .offer -->
            <div class="offer">
                <img alt="product" src="assets/images/menu/main2.jpg">
                <div class="offer-price-small">
                    <span class="offer-price-val1">125</span><span class="offer-price-val2">грн</span>
                </div>
                <div class="offer-detail">
            ...
            <!-- .offer -->
            <div class="offer">
                <img alt="product" src="assets/images/menu/main3.jpg">
                <div class="offer-price-small">
                    <span class="offer-price-val1">125</span><span class="offer-price-val2">грн</span>
                </div>
                <div class="offer-detail">
                            ...
                            <div class="centered-columns">
                                <div class="centered-column">
                                    <div class="banner-1-detail">
                                        THE BEST PIZZA<br>
                                        <strong>TEMPLATE</strong> ON ENVATO<br> MARKET
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 responsive-column">
                        <div class="icon-box">
                            ...
                            <h3 class="bottom-line">Pizza Slices</h3>
                    ...
                    <div class="col-md-6 responsive-column">
                        <div class="icon-box">
                            ...
                            <h3 class="bottom-line">Tomato CSS</h3>
                            When gliding by the Bashee isles we emerged at last upon the great South Sea, were it not for other things, I could have greeted.
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 responsive-column">
                        <div class="icon-box">
                            ...
                            <h3 class="bottom-line">Mushroom HTML</h3>
                            When gliding by the Bashee isles we emerged at last upon the great South Sea, were it not for other things, I could have greeted.
                        </div>
                    </div>
                    <div class="col-md-6 responsive-column">
                        <div class="icon-box">
                            ...
                            <h3 class="bottom-line">Olives</h3>
                            When gliding by the Bashee isles we emerged at last upon the great South Sea, were it not for other things, I could have greeted.
                        </div>
                    </div>
                </div>
